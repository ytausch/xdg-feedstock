...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xdg-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2156&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xdg-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xdg` can be installed with `conda`:
...
It is possible to list all of the versions of `xdg` available on your platform with `conda`:
...
```
mamba search xdg --channel conda-forge
```
...
mamba repoquery search xdg --channel conda-forge

# List packages depending on `xdg`:
mamba repoquery whoneeds xdg --channel conda-forge

# List dependencies of `xdg`:
mamba repoquery depends xdg --channel conda-forge
```
